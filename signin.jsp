  ...
  <body class="h-full w-full bg-base-300 fixed">
    <div class="w-full h-10 flex justify-between">
      <div class="m-2">
        ...
        <div class="card w-[50%] bg-base-100 card-md shadow-sm m-auto mt-40">
            <div class="card-body">
              <h1 class="card-title text-4xl font-bold m-auto">Bienvenue sur UniVerseLille !</h1>
              <h2 class="text-2xl m-auto">Connexion</h2>
                <%
                  String tentative = request.getParameter("tentative");
                  if(tentative!=null && Integer.parseInt(tentative)==1){
                      out.println("<div class=\"alert alert-error\">");
                      out.println("<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-6 w-6 shrink-0 stroke-current\" fill=\"none\" viewBox=\"0 0 24 24\">");
              ...
              <form class="card" action="Connexion" method="post">
                <div>
                  <label class="input validator m-4">
                    ...
                    <input name="login" required placeholder="Username"/>
                  </label>
                </div>
                <div>
                  <label class="input validator m-4">
                ...
                <div class="justify-end card-actions m-4">
                  <a class="btn" href="signup.jsp">Créer un compte</a>
